...
--
-- Host: 172.18.0.3    Database: limpio
-- ------------------------------------------------------
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Admin Notification Viewer Log Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `admin_passwords` VALUES
(1,1,'8ff92ad1ac54b878a64b90ed887254d1a6529db072b729d8c07e59b688b4d13a:GqeeLM2HpF5J1Eckn5jqic6BPEep9C1Q:3_32_2_67108864',0,1741740976);
...
(1,'admin','magento','admin@local.com','admin','8ff92ad1ac54b878a64b90ed887254d1a6529db072b729d8c07e59b688b4d13a:GqeeLM2HpF5J1Eckn5jqic6BPEep9C1Q:3_32_2_67108864','2025-03-12 00:56:16','2025-03-12 00:56:16',NULL,0,0,1,NULL,NULL,NULL,'en_US',0,NULL,NULL);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Admin User sessions table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `adminnotification_inbox` VALUES
(1,4,'2025-03-12 00:56:15','Disable Notice','To improve performance, collecting statistics for the Magento Report module is disabled by default. \nYou can enable it in System Config.','',0,0);
...
INSERT INTO `authorization_role` VALUES
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Category Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,3,0,'2025-03-12 00:56:14','2025-03-12 00:56:14','1',0,0,1),
(2,3,1,'2025-03-12 00:56:14','2025-03-12 00:56:14','1/2',1,1,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Category Integer Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Category Varchar Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product To Category Linkage Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Bundle Option';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Bundle Option Value';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Bundle Selection';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Datetime Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Decimal Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Integer Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Media Gallery Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Media Gallery Attribute Value Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Text Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Varchar Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product To Product Linkage Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Link Decimal Attribute Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Catalog Product Link Integer Attribute Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Cataloginventory Stock Item';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_catalogrule_product_price_after_insert AFTER INSERT ON catalogrule_product_price FOR EACH ROW
BEGIN
INSERT IGNORE INTO `catalog_product_price_cl` (`entity_id`) VALUES (NEW.`product_id`);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_catalogrule_product_price_after_update AFTER UPDATE ON catalogrule_product_price FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_catalogrule_product_price_after_delete AFTER DELETE ON catalogrule_product_price FOR EACH ROW
BEGIN
INSERT IGNORE INTO `catalog_product_price_cl` (`entity_id`) VALUES (OLD.`product_id`);
END */;;
DELIMITER ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='CMS Block Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='CMS Page Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Config Data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'default',0,'catalog/search/engine','elasticsearch7','2025-03-12 00:51:27'),
(2,'default',0,'catalog/search/elasticsearch7_server_hostname','elasticsearch7','2025-03-12 00:56:08'),
(3,'default',0,'catalog/search/elasticsearch7_server_port','9200','2025-03-12 00:51:27'),
(4,'default',0,'web/seo/use_rewrites','1','2025-03-12 00:56:08'),
(5,'default',0,'web/unsecure/base_url','https://limpio.local/','2025-03-12 00:56:08'),
(6,'default',0,'general/locale/code','en_US','2025-03-12 00:56:08'),
(7,'default',0,'general/locale/timezone','America/Chicago','2025-03-12 00:56:08'),
(8,'default',0,'currency/options/base','USD','2025-03-12 00:56:08'),
(9,'default',0,'currency/options/default','USD','2025-03-12 00:56:08'),
(10,'default',0,'currency/options/allow','USD','2025-03-12 00:56:08'),
(11,'default',0,'general/region/display_all','1','2025-03-12 00:56:09'),
(12,'default',0,'general/region/state_required','AL,AR,AU,BG,BO,BR,BY,CA,CH,CL,CN,CO,CR,CZ,DK,EC,EE,ES,GR,GY,HR,IN,IS,IT,LT,LV,MX,PE,PL,PT,PY,RO,SE,SR,UA,US,UY,VE','2025-03-12 00:56:13'),
(13,'default',0,'catalog/category/root_id','2','2025-03-12 00:56:14'),
(14,'default',0,'twofactorauth/duo/application_key','rKVXy6d5OdF1O0NGbhqo7qcFr9t2t9Jvc3cuzwQaCMCAwbeq0xAQjBeLJ6mjbOjF','2025-03-12 00:56:15'),
(15,'default',0,'analytics/subscription/enabled','1','2025-03-12 00:56:15'),
(16,'default',0,'crontab/default/jobs/analytics_subscribe/schedule/cron_expr','0 * * * *','2025-03-12 00:56:15'),
(17,'default',0,'crontab/default/jobs/analytics_collect_data/schedule/cron_expr','00 02 * * *','2025-03-12 00:56:15'),
(18,'default',0,'msp_securitysuite_recaptcha/frontend/enabled','0','2025-03-12 00:56:15'),
(19,'default',0,'msp_securitysuite_recaptcha/backend/enabled','0','2025-03-12 00:56:15');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Customer Address Entity';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Customer Entity';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Data Export Items UUID References Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1157 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Directory Country Region';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=137 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Eav Attribute';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Eav Attribute Group';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Eav Attribute Label';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Eav Attribute Option';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Eav Attribute Option Value';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Eav Attribute Set';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Eav Entity Attributes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Flag';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'analytics_link_attempts_reverse_counter',0,'24','2025-03-12 00:56:15');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Import history table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `importexport_importdata` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Import Data Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Indexer State';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'design_config_grid','valid','2025-03-12 00:58:43','8d9b09e5adbccd70321feeedb4d6d8a9'),
(2,'customer_grid','valid','2025-03-12 00:56:16','ba7d6125fd11f2d4c0f616b3f7fb169d'),
(3,'catalog_category_product','invalid','2025-03-12 00:56:14','d0072caa7a9a0bdde2212a5ad7d0e2b9'),
(4,'catalog_product_category','invalid','2025-03-12 00:56:14','4293e277a49ecb182198f136887a3dc1'),
(5,'catalogrule_rule','invalid','2025-03-12 00:56:14','87f7cbde56dd74f95060cf034bacd5c4'),
(6,'catalog_product_attribute','invalid','2025-03-12 00:56:14','a8aae254224304ae53c7de931a86478a'),
(7,'cataloginventory_stock','invalid','2025-03-12 00:56:14','6e8291def34504811de2b1d9d2bbb564'),
(8,'inventory','invalid','2025-03-12 00:56:14','853632ac47224586f08fc356c1b1dc64'),
(9,'catalogrule_product','invalid','2025-03-12 00:56:14','b09472d1021a92ac86eda01bc30ac3f3'),
(10,'catalog_product_price','invalid','2025-03-12 00:56:14','6617eba8b55438623a06830ff3e68d8c'),
(11,'catalogsearch_fulltext','invalid','2025-03-12 00:56:14','b0ff1ee0de536a99115e1ae9b1c5bba7'),
(12,'sales_order_data_exporter','invalid','2025-03-12 00:56:14','edd789888b3439212de76d0df9c6bb17'),
(13,'sales_order_status_data_exporter','invalid','2025-03-12 00:56:14','4c221ca52543c376e8a9bfad92b4a39b'),
(14,'store_data_exporter','invalid','2025-03-12 00:56:14','c3423c767c9dc01bb1d6307d31e8eb84');
...
INSERT INTO `inventory_source_stock_link` VALUES
(1,1,'default',1);
...
INSERT INTO `inventory_stock_sales_channel` VALUES
('website','base',1);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Layout Link';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='View State';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'sales_order_data_exporter','enabled','idle','2025-03-12 00:58:42',NULL),
(2,'sales_order_status_data_exporter','enabled','idle','2025-03-12 00:58:42',NULL),
(3,'store_data_exporter','enabled','idle','2025-03-12 00:58:43',NULL),
(4,'design_config_dummy','enabled','idle','2025-03-12 00:58:43',0),
(5,'customer_dummy','enabled','idle','2025-03-12 00:58:40',NULL),
(6,'catalog_category_product','enabled','idle','2025-03-12 00:58:40',NULL),
(7,'catalog_product_category','enabled','idle','2025-03-12 00:58:41',NULL),
(8,'catalogrule_rule','enabled','idle','2025-03-12 00:58:41',NULL),
(9,'catalog_product_attribute','enabled','idle','2025-03-12 00:58:41',NULL),
(10,'cataloginventory_stock','enabled','idle','2025-03-12 00:58:41',NULL),
(11,'inventory','enabled','idle','2025-03-12 00:58:41',NULL),
(12,'catalogrule_product','enabled','idle','2025-03-12 00:58:41',NULL),
(13,'catalog_product_price','enabled','idle','2025-03-12 00:58:42',NULL),
(14,'catalogsearch_fulltext','enabled','idle','2025-03-12 00:58:42',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=185 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='List of data/schema patches';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(140,'Magento\\Elasticsearch\\Setup\\Patch\\Data\\InvalidateIndex'),
(141,'Magento\\Email\\Setup\\Patch\\Data\\FlagLegacyTemplates'),
(142,'Magento\\EncryptionKey\\Setup\\Patch\\Data\\SodiumChachaPatch'),
(143,'Magento\\Fedex\\Setup\\Patch\\Data\\ConfigureFedexDefaults'),
(144,'Magento\\GiftMessage\\Setup\\Patch\\Data\\AddGiftMessageAttributes'),
(145,'Magento\\GiftMessage\\Setup\\Patch\\Data\\MoveGiftMessageToGiftOptionsGroup'),
(146,'Magento\\GiftMessage\\Setup\\Patch\\Data\\UpdateGiftMessageAttribute'),
(147,'Magento\\GroupedProduct\\Setup\\Patch\\Data\\InitializeGroupedProductLinks'),
(148,'Magento\\GroupedProduct\\Setup\\Patch\\Data\\UpdateProductRelations'),
(149,'Magento\\ConfigurableProduct\\Setup\\Patch\\Data\\InstallInitialConfigurableAttributes'),
(150,'Magento\\ConfigurableProduct\\Setup\\Patch\\Data\\UpdateManufacturerAttribute'),
(151,'Magento\\ConfigurableProduct\\Setup\\Patch\\Data\\UpdateTierPriceAttribute'),
(152,'Magento\\InventoryLowQuantityNotification\\Setup\\Patch\\Data\\MigrateCatalogInventoryNotifyStockQuantityData'),
(153,'Magento\\Reports\\Setup\\Patch\\Data\\InitializeReportEntityTypesAndPages'),
(154,'Magento\\Reports\\Setup\\Patch\\Data\\ReportDisableNotification'),
(155,'Magento\\SalesRule\\Setup\\Patch\\Data\\PrepareRuleModelSerializedData'),
(156,'Magento\\SalesRule\\Setup\\Patch\\Data\\ConvertSerializedDataToJson'),
(157,'Magento\\SalesRule\\Setup\\Patch\\Data\\FillSalesRuleProductAttributeTable'),
(158,'Magento\\PageBuilder\\Setup\\Patch\\Data\\UpdateProductAttribute'),
(159,'Magento\\PageBuilder\\Setup\\Patch\\Data\\UpgradePageBuilderStripStyles'),
(160,'Magento\\Vault\\Setup\\Patch\\Data\\SetCreditCardAsDefaultTokenType'),
(161,'Magento\\Paypal\\Setup\\Patch\\Data\\AddPaypalOrderStatuses'),
(162,'Magento\\Paypal\\Setup\\Patch\\Data\\UpdateBmltoPayLater'),
(163,'Magento\\Paypal\\Setup\\Patch\\Data\\UpdatePaypalCreditOption'),
(164,'Magento\\Paypal\\Setup\\Patch\\Data\\UpdateSmartButtonLabel'),
(165,'Magento\\Paypal\\Setup\\Patch\\Data\\UpdateSmartButtonSize'),
(166,'Magento\\ServicesId\\Setup\\Patch\\Data\\RemoveKeySetEncryptedConfigFlag'),
(167,'Magento\\ReCaptchaMigration\\Setup\\Patch\\Data\\MigrateConfigToRecaptchaModules'),
(168,'Magento\\Review\\Setup\\Patch\\Data\\InitReviewStatusesAndData'),
(169,'Magento\\OfflineShipping\\Setup\\Patch\\Data\\UpdateQuoteShippingAddresses'),
(170,'Magento\\OfflineShipping\\Setup\\Patch\\Data\\UpdateShippingTablerate'),
(171,'Magento\\UrlRewrite\\Setup\\Patch\\Data\\ConvertSerializedDataToJson'),
(172,'Magento\\Swatches\\Setup\\Patch\\Data\\AddSwatchImageAttribute'),
(173,'Magento\\Swatches\\Setup\\Patch\\Data\\AddSwatchImageToDefaultAttribtueSet'),
(174,'Magento\\Swatches\\Setup\\Patch\\Data\\UpdateAdminTextSwatchValues'),
(175,'Magento\\Swatches\\Setup\\Patch\\Data\\ConvertAdditionalDataToJson'),
(176,'Magento\\Tax\\Setup\\Patch\\Data\\AddTaxAttributeAndTaxClasses'),
(177,'Magento\\Tax\\Setup\\Patch\\Data\\UpdateTaxClassAttributeVisibility'),
(178,'Magento\\Tax\\Setup\\Patch\\Data\\UpdateTaxRegionId'),
(179,'Magento\\SampleData\\Setup\\Patch\\Data\\ClearSampleDataState'),
(180,'Magento\\Usps\\Setup\\Patch\\Data\\UpdateAllowedMethods'),
(181,'Magento\\Weee\\Setup\\Patch\\Data\\InitQuoteAndOrderAttributes'),
(182,'Magento\\CurrencySymbol\\Setup\\Patch\\Data\\ConvertSerializedCustomCurrencySymbolToJson'),
(183,'Magento\\Wishlist\\Setup\\Patch\\Data\\ConvertSerializedData'),
(184,'Magento\\Wishlist\\Setup\\Patch\\Data\\WishlistDataCleanUp');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Payment Services Order Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_services_order_status_data_prod_submitted_hash` (
  ...
  `submitted_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Submitted At',
  PRIMARY KEY (`identifier`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Payment Services Order Status Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_services_store_data_production_submitted_hash` (
  ...
  `submitted_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Submitted At',
  PRIMARY KEY (`identifier`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Payment Services Store Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Table storing unique queues';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `queue_message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Queue messages';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Relation table to keep associations between queues and messages';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Flat Quote';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Flat Quote Address';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Flat Quote Item';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Flat Quote Item Option';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Flat Quote Payment';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Flat Quote Shipping Rate';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Ratings';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Rating options';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Rating option values';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Rating vote aggregated';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Review base information';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Review detail information';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Review aggregates';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Order Statuses Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Orders Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Flat Order';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_order_after_insert AFTER INSERT ON sales_order FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_order_after_update AFTER UPDATE ON sales_order FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_order_after_delete AFTER DELETE ON sales_order FOR EACH ROW
BEGIN
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Flat Order Address';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sales_order_data_exporter_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='sales_order_data_exporter_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Flat Order Item';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_order_item_after_insert AFTER INSERT ON sales_order_item FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_order_item_after_update AFTER UPDATE ON sales_order_item FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_order_item_after_delete AFTER DELETE ON sales_order_item FOR EACH ROW
BEGIN
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Sales Flat Order Payment';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_order_status_after_insert AFTER INSERT ON sales_order_status FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_order_status_after_update AFTER UPDATE ON sales_order_status FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_order_status_after_delete AFTER DELETE ON sales_order_status FOR EACH ROW
BEGIN
...
CREATE TABLE `sales_order_status_data_exporter_cl` (
  ...
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='sales_order_status_data_exporter_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sales_order_status_data_exporter_cl` VALUES
(1,'pending'),
(2,'pending_payment'),
(3,'processing'),
(4,'holded'),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_payment_transaction_after_insert AFTER INSERT ON sales_payment_transaction FOR EACH ROW
BEGIN
INSERT IGNORE INTO `sales_order_data_exporter_cl` (`entity_id`) VALUES (NEW.`order_id`);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_payment_transaction_after_update AFTER UPDATE ON sales_payment_transaction FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_sales_payment_transaction_after_delete AFTER DELETE ON sales_payment_transaction FOR EACH ROW
BEGIN
INSERT IGNORE INTO `sales_order_data_exporter_cl` (`entity_id`) VALUES (OLD.`order_id`);
END */;;
DELIMITER ;
...
INSERT INTO `setup_module` VALUES
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Shipping Tablerate';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_store_after_insert AFTER INSERT ON store FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_store_after_update AFTER UPDATE ON store FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_store_after_delete AFTER DELETE ON store FOR EACH ROW
BEGIN
...
CREATE TABLE `store_data_exporter_cl` (
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  PRIMARY KEY (`version_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='store_data_exporter_cl';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `store_data_exporter_cl` VALUES
(1,0),
(2,1);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_store_group_after_insert AFTER INSERT ON store_group FOR EACH ROW
BEGIN
INSERT IGNORE INTO `store_data_exporter_cl` (`entity_id`) VALUES (NEW.`website_id`);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_store_group_after_update AFTER UPDATE ON store_group FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_store_group_after_delete AFTER DELETE ON store_group FOR EACH ROW
BEGIN
INSERT IGNORE INTO `store_data_exporter_cl` (`entity_id`) VALUES (OLD.`website_id`);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_store_website_after_insert AFTER INSERT ON store_website FOR EACH ROW
BEGIN
INSERT IGNORE INTO `store_data_exporter_cl` (`entity_id`) VALUES (NEW.`website_id`);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_store_website_after_update AFTER UPDATE ON store_website FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER trg_store_website_after_delete AFTER DELETE ON store_website FOR EACH ROW
BEGIN
INSERT IGNORE INTO `store_data_exporter_cl` (`entity_id`) VALUES (OLD.`website_id`);
END */;;
DELIMITER ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Stores Feed Storage';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=242 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='tfa_country_codes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tfa_country_codes` VALUES
(1,'IL','Israel','+972'),
(2,'AF','Afghanistan','+93'),
(3,'AL','Albania','+355'),
(4,'DZ','Algeria','+213'),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='tfa_user_config';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,NULL,'Magento/blank','Magento Blank','preview_image_67d0dbad580d7.jpeg',0,'frontend',0,'Magento/blank'),
(2,NULL,'Magento/backend','Magento 2 backend',NULL,0,'adminhtml',0,'Magento/backend'),
(3,1,'Magento/luma','Magento Luma','preview_image_67d0dbad65d1b.jpeg',0,'frontend',0,'Magento/luma');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Bookmark';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Url Rewrites';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Instances of Widget for Package Theme';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Instance of Widget on Page';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Wishlist main Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-03-12 11:15:25
